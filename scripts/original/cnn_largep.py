...
from keras.layers import Dense, Activation, Flatten, Conv3D,MaxPooling3D
...
#no padding #width,height,depth,channels
	model.add(Conv3D(3, kernel_size=(40,40,40),strides=(20,20,20), activation='relu', input_shape=(120,120,120,2)))
# --- max pool ---
...
model.save('expnew4.h5')  # creates a HDF5 file 'my_model.h5'
del parallel_model  # deletes the existing model
